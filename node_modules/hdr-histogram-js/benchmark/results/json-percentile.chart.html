...
<html lang="en">
  ...
  <body>
    <div style="max-width: 800px;">
      <canvas id="chart1595165899229" width="16" height="9"></canvas>
    </div>
    <script>
      const format = num => {
        const chunked = [];
      ...
      const ctx1595165899229 = document
        .getElementById("chart1595165899229")
        .getContext("2d");
      const chart1595165899229 = new Chart(ctx1595165899229, {
        type: "bar",
        data: {
          labels: [
            "JS 32B Histogram",
