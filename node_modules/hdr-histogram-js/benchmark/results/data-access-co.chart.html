...
<html lang="en">
  <head>
    ...
    <title>Histogram data access with coordinated ommissions</title>
  </head>
  <body>
    <div style="max-width: 800px;">
      <canvas id="chart1591690005593" width="16" height="9"></canvas>
    </div>
    <script>
      const format = num => {
        const chunked = [];
      ...
      const ctx1591690005593 = document
        .getElementById("chart1591690005593")
        .getContext("2d");
      const chart1591690005593 = new Chart(ctx1591690005593, {
        type: "bar",
        data: {
          labels: [
            "Int32Histogram",
        ...
        options: {
          ...
          title: {
            display: true,
            text: "Histogram data access with coordinated ommissions",
            fontSize: 16,
            padding: 20
          },
          tooltips: {
