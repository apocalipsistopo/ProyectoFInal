    ...
    var ProviderElementContext = /** @class */ (function () {
        ...
        Object.defineProperty(ProviderElementContext.prototype, "queryMatches", {
            get: function () {
                ...
                this._queriedTokens.forEach(function (matches) {
                    allMatches.push.apply(allMatches, tslib_1.__spreadArray([], tslib_1.__read(matches)));
                });
                return allMatches;
            },
            enumerable: false,
        ...
        ProviderElementContext.prototype._getQueriesFor = function (token) {
            ...
            while (currentEl !== null) {
                ...
                if (queries) {
                    result.push.apply(result, tslib_1.__spreadArray([], tslib_1.__read(queries.filter(function (query) { return query.meta.descendants || distance <= 1; }))));
                }
            ...
            if (queries) {
                result.push.apply(result, tslib_1.__spreadArray([], tslib_1.__read(queries)));
            }
            return result;
        };
